...
class MenuSeleccionPersonajes2 extends Phaser.Scene {
    
    constructor() {
        super("Menu-Seleccion-Personajes-2");
    };
    ...
    create() {
      ...
      //BOTON ABANDONAR SERVIDOR
        ...
        this.personajeSimbolo[0].on("pointerover", function(){
        	that.puntero[1].setPosition(that.personajeSimbolo[0].x, that.personajeSimbolo[0].y);
        	that.puntero[1].setVelocity(0, 0);
        });
        ...
        this.personajeSimbolo[1].on("pointerover", function(){
        	that.puntero[1].setPosition(that.personajeSimbolo[1].x, that.personajeSimbolo[1].y);
        	that.puntero[1].setVelocity(0, 0);
        });
        ...
        this.personajeSimbolo[2].on("pointerover", function(){
        	that.puntero[1].setPosition(that.personajeSimbolo[2].x, that.personajeSimbolo[2].y);
        	that.puntero[1].setVelocity(0, 0);
        });
        ...
        this.personajeSimbolo[3].on("pointerover", function(){
        	that.puntero[1].setPosition(that.personajeSimbolo[3].x, that.personajeSimbolo[3].y);
        	that.puntero[1].setVelocity(0, 0);
        });
